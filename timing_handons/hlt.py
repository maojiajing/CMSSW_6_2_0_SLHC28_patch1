# hltGetConfiguration /users/HLTTutoOct2017/ExamplePath/Mu3Jet200Btag/V1 --globaltag 92X_dataRun2_HLT_v7 --input root://eoscms.cern.ch//eos/cms/tier0/store/data/Run2017E/EphemeralHLTPhysics1/RAW/v1/000/304/777/00000/00175E91-D0AD-E711-A24F-02163E01451E.root --data --process TIMING --offline --l1 L1Menu_Collisions2017_v4_m6 --prescale 1.6e34 --max-events 100 --setup /dev/CMSSW_9_2_0/GRun --no-output --timing

# /users/HLTTutoOct2017/ExamplePath/Mu3Jet200Btag/V1 (CMSSW_9_2_10)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/HLTTutoOct2017/ExamplePath/Mu3Jet200Btag/V1')
)
...
process.hltPreMu3PFJet200CSV1p5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltMuon4L1Filtered0 = cms.EDFilter( "HLTMuonL1TFilter",
    saveTags = cms.bool( True ),
...
process.hltMuon4L2Filtered0 = cms.EDFilter( "HLTMuonL2FromL1TPreFilter",
    saveTags = cms.bool( True ),
    MaxDr = cms.double( 9999.0 ),
    CutOnChambers = cms.bool( False ),
    PreviousCandTag = cms.InputTag( "hltMuon4L1Filtered0" ),
    MinPt = cms.double( 0.0 ),
    MinN = cms.int32( 0 ),
...
process.hltL1fForIterL3Muon4L1Filtered0 = cms.EDFilter( "HLTMuonL1TFilter",
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltMuon4L1Filtered0" ),
    MinPt = cms.double( 0.0 ),
    MinN = cms.int32( 1 ),
...
process.hltL3MuFiltered3 = cms.EDFilter( "HLTMuonL3PreFilter",
    ...
    L1CandTag = cms.InputTag( "hltL1fForIterL3Muon4L1Filtered0" ),
    ...
    PreviousCandTag = cms.InputTag( "hltMuon4L2Filtered0" ),
    MaxEta = cms.double( 2.5 ),
...
process.hltPFJetFilter200 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
...
process.hltPFJetForBtagSelector200 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MaxMass = cms.double( -1.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 2.6 ),
...
process.hltPFJetForBtag200 = cms.EDProducer( "HLTPFJetCollectionProducer",
    TriggerTypes = cms.vint32( 86 ),
    HLTObject = cms.InputTag( "hltPFJetForBtagSelector200" )
)
process.hltBLifetimeAssociatorPF200 = cms.EDProducer( "JetTracksAssociatorAtVertex",
    jets = cms.InputTag( "hltPFJetForBtag200" ),
    tracks = cms.InputTag( "hltPFMuonMerging" ),
    useAssigned = cms.bool( False ),
    coneSize = cms.double( 0.4 ),
    pvSrc = cms.InputTag( "" )
)
process.hltBLifetimeTagInfosPF200 = cms.EDProducer( "TrackIPProducer",
    ...
    jetTracks = cms.InputTag( "hltBLifetimeAssociatorPF200" ),
...
process.hltSecondaryVertexTagInfosPF200 = cms.EDProducer( "SecondaryVertexProducer",
    ...
    trackIPTagInfos = cms.InputTag( "hltBLifetimeTagInfosPF200" ),
    vertexCuts = cms.PSet( 
...
process.hltCombinedSecondaryVertexBJetTagsPF200 = cms.EDProducer( "JetTagProducer",
    jetTagComputer = cms.string( "hltCombinedSecondaryVertexV2" ),
    tagInfos = cms.VInputTag( 'hltBLifetimeTagInfosPF200','hltSecondaryVertexTagInfosPF200' )
)
process.hltBTagPF200CSVp080Single = cms.EDFilter( "HLTPFJetTag",
    saveTags = cms.bool( True ),
    MinJets = cms.int32( 1 ),
    JetTags = cms.InputTag( "hltCombinedSecondaryVertexBJetTagsPF200" ),
    TriggerType = cms.int32( 86 ),
    Jets = cms.InputTag( "hltPFJetForBtag200" ),
...
process.hltPrePFHT430SixPFJet40PFBTagCSV1p5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltCaloJetFilterSixC35 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
    MaxMass = cms.double( -1.0 ),
    MinN = cms.int32( 6 ),
    MaxEta = cms.double( 2.6 ),
...
process.hltCaloJetsSix35ForHt = cms.EDProducer( "HLTCaloJetCollectionProducer",
    TriggerTypes = cms.vint32( 86 ),
    HLTObject = cms.InputTag( "hltCaloJetFilterSixC35" )
)
process.hltHtMhtCaloJetsSixC35 = cms.EDProducer( "HLTHtMhtProducer",
    usePt = cms.bool( True ),
    minPtJetHt = cms.double( 35.0 ),
    maxEtaJetMht = cms.double( 5.0 ),
    minNJetMht = cms.int32( 0 ),
    jetsLabel = cms.InputTag( "hltCaloJetsSix35ForHt" ),
...
process.hltCaloSixJet35HT300 = cms.EDFilter( "HLTHtMhtFilter",
    saveTags = cms.bool( True ),
    mhtLabels = cms.VInputTag( 'hltHtMhtCaloJetsSixC35' ),
    meffSlope = cms.vdouble( 1.0 ),
    minMeff = cms.vdouble( 0.0 ),
    minMht = cms.vdouble( 0.0 ),
    htLabels = cms.VInputTag( 'hltHtMhtCaloJetsSixC35' ),
    minHt = cms.vdouble( 300.0 )
)
process.hltPFJetFilterSixC40 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MaxMass = cms.double( -1.0 ),
    MinN = cms.int32( 6 ),
    MaxEta = cms.double( 2.6 ),
...
process.hltPFJetsSix40ForHt = cms.EDProducer( "HLTPFJetCollectionProducer",
    TriggerTypes = cms.vint32( 86 ),
    HLTObject = cms.InputTag( "hltPFJetFilterSixC40" )
)
process.hltHtMhtPFJetsSixC40 = cms.EDProducer( "HLTHtMhtProducer",
    usePt = cms.bool( True ),
    minPtJetHt = cms.double( 40.0 ),
    maxEtaJetMht = cms.double( 999.0 ),
    minNJetMht = cms.int32( 0 ),
    jetsLabel = cms.InputTag( "hltPFJetsSix40ForHt" ),
    maxEtaJetHt = cms.double( 2.6 ),
    minPtJetMht = cms.double( 0.0 ),
    minNJetHt = cms.int32( 6 ),
...
process.hltPFSixJet40HT430 = cms.EDFilter( "HLTHtMhtFilter",
    saveTags = cms.bool( True ),
    mhtLabels = cms.VInputTag( 'hltHtMhtPFJetsSixC40' ),
    meffSlope = cms.vdouble( 1.0 ),
    minMeff = cms.vdouble( 0.0 ),
    minMht = cms.vdouble( 0.0 ),
    htLabels = cms.VInputTag( 'hltHtMhtPFJetsSixC40' ),
...
process.HLTBtagPt200CSVSequencePF = cms.Sequence( process.hltVerticesPF + process.hltVerticesPFSelector + process.hltVerticesPFFilter + process.hltPFJetForBtagSelector200 + process.hltPFJetForBtag200 + process.hltBLifetimeAssociatorPF200 + process.hltBLifetimeTagInfosPF200 + process.hltInclusiveVertexFinderPF + process.hltInclusiveSecondaryVerticesPF + process.hltTrackVertexArbitratorPF + process.hltInclusiveMergedVerticesPF + process.hltSecondaryVertexTagInfosPF200 + process.hltCombinedSecondaryVertexBJetTagsPF200 )
...
process.HLT_Mu3_PFJet200CSV_1p5_v15 = cms.Path( process.HLTBeginSequence + process.hltL1SingleJet180 + cms.ignore(process.hltL1sSingleMuOpenObjectMap) + process.hltPreMu3PFJet200CSV1p5 + process.hltMuon4L1Filtered0 + process.HLTL2muonrecoSequence + cms.ignore(process.hltMuon4L2Filtered0) + process.HLTL3muonrecoSequence + cms.ignore(process.hltL1fForIterL3Muon4L1Filtered0) + process.hltL3MuFiltered3 + process.HLTAK4PFJetsSequence + process.hltPFJetFilter200 + process.HLTBtagPt200CSVSequencePF + process.hltBTagPF200CSVp080Single + process.HLTEndSequence )
process.HLT_Mu3_L1SingleJet180_v15 = cms.Path( process.HLTBeginSequence + process.hltL1SingleJet180 + cms.ignore(process.hltL1sSingleMuOpenObjectMap) + process.hltPreMu3L1SingleJet180 + process.hltMuon4L1Filtered0 + process.HLTL2muonrecoSequence + cms.ignore(process.hltMuon4L2Filtered0) + process.HLTL3muonrecoSequence + cms.ignore(process.hltL1fForIterL3Muon4L1Filtered0) + process.hltL3MuFiltered3 + process.HLTEndSequence )
process.HLT_PFJet200CSV_1p5_v15 = cms.Path( process.HLTBeginSequence + process.hltL1SingleJet180 + process.hltPrePFJet200CSV1p5 + process.HLTAK4PFJetsSequence + process.hltPFJetFilter200 + process.HLTBtagPt200CSVSequencePF + process.hltBTagPF200CSVp080Single + process.HLTEndSequence )
process.HLT_PFHT430_SixPFJet40_PFBTagCSV_1p5_v5 = cms.Path( process.HLTBeginSequence + process.hltL1sHTT280to500erIorHTT250to340erQuadJet + process.hltPrePFHT430SixPFJet40PFBTagCSV1p5 + process.HLTAK4CaloJetsSequence + process.hltCaloJetFilterSixC35 + process.hltCaloJetsSix35ForHt + process.hltHtMhtCaloJetsSixC35 + process.hltCaloSixJet35HT300 + process.HLTAK4PFJetsSequence + process.hltPFJetFilterSixC40 + process.hltPFJetsSix40ForHt + process.hltHtMhtPFJetsSixC40 + process.hltPFSixJet40HT430 + process.HLTBtagCSVSequencePF + process.hltBTagPFCSVp080Single + process.HLTEndSequence )
process.HLT_Mu15_IsoVVVL_PFHT450_v11 = cms.Path( process.HLTBeginSequence + process.hltL1sHTT380erIorHTT320er + process.hltPreMu15IsoVVVLPFHT450 + cms.ignore(process.hltL1sSingleMuOpenObjectMap) + process.HLTAK4CaloJetsSequence + process.hltHtMhtJet30 + process.hltHT200Jet30 + process.hltL1fL1sSingleMuOpenCandidateL1Filtered0 + process.HLTL2muonrecoSequence + cms.ignore(process.hltL2fL1sSingleMuOpenCandidateL1f0L2Filtered0Q) + process.HLTL3muonrecoSequence + cms.ignore(process.hltL1fForIterL3L1fL1sSingleMuOpenCandidateL1Filtered0) + process.hltL3fL1sSingleMuOpenCandidateL1f0L2f3QL3Filtered15Q + process.HLTMuVVVLCombinedIsolationR02Sequence + process.hltL3MuVVVLIsoFIlter + process.HLTAK4PFJetsSequence + process.hltPFHTJet30 + process.hltPFHT450Jet30 + process.HLTEndSequence )
process.HLT_PFJet500_v17 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet170IorSingleJet180IorSingleJet200 + process.hltPrePFJet500 + process.HLTAK4CaloJetsSequence + process.hltSingleCaloJet450 + process.HLTAK4PFJetsSequence + process.hltPFJetsCorrectedMatchedToCaloJets450 + process.hltSinglePFJet500 + process.HLTEndSequence )
process.HLTriggerFinalPath = cms.Path( process.hltGtStage2Digis + process.hltScalersRawToDigi + process.hltFEDSelector + process.hltTriggerSummaryAOD + process.hltTriggerSummaryRAW + process.hltBoolFalse )


process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_Mu3_PFJet200CSV_1p5_v15, process.HLT_Mu3_L1SingleJet180_v15, process.HLT_PFJet200CSV_1p5_v15, process.HLT_PFHT430_SixPFJet40_PFBTagCSV_1p5_v5, process.HLT_Mu15_IsoVVVL_PFHT450_v11, process.HLT_PFJet500_v17, process.HLTriggerFinalPath ))


process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'root://eoscms.cern.ch//eos/cms/tier0/store/data/Run2017E/EphemeralHLTPhysics1/RAW/v1/000/304/777/00000/00175E91-D0AD-E711-A24F-02163E01451E.root',
    ),
...
if 'GlobalTag' in process.__dict__:
    ...
    process.GlobalTag = customiseGlobalTag(process.GlobalTag, globaltag = '92X_dataRun2_HLT_v7', conditions = 'L1Menu_Collisions2017_v4_m6,L1TUtmTriggerMenuRcd,,,9999-12-31 23:59:59.000')
